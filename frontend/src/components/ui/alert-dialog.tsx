...
function AlertDialogFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "-mx-4 -mb-4 flex flex-row flex-wrap items-center justify-end gap-2 rounded-b-xl border-t border-border/70 bg-muted/60 px-4 py-3",
        className,
      )}
      {...props}
    />
